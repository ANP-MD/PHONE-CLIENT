...
namespace AkulavLauncherInstaller
{
    ...
    {
        readonly static string location = "C:\\PrisonPhone\\";
        readonly string fileLocation = "C:\\PrisonPhone\\file.zip";
        readonly string updateFlag = "C:\\PrisonPhone\\update.txt";
        ...
        private void InstallBtn_Click(object sender, EventArgs e)
        {
            ...
            link.SetPath(@"C:\\PrisonPhone\\TelefonDepistat.exe");

            // save it
            IPersistFile file = (IPersistFile)link;
            string desktopPath = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory);
            file.Save(Path.Combine(desktopPath, "PrisonPhone.lnk"), false);

            var p = new Process();
            p.StartInfo.FileName = @"C:\PrisonPhone\TelefonDepistat.exe";
            p.Start();
        ...
        private void UninstallBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                File.Delete(Path.Combine(desktopPath, "PrisonPhone.lnk"));
